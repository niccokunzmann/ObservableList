...
# -*- coding: utf-8 -*-
#
# ObservableList documentation build configuration file, created by
...
project = 'ObservableList'
copyright = '2016, niccokunzmann'
...
htmlhelp_basename = 'ObservableListdoc'
...
latex_documents = [
    (master_doc, 'ObservableList.tex', 'ObservableList Documentation',
     'niccokunzmann', 'manual'),
]
